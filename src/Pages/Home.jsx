...
<div className="pagination-container flex justify-between mt-5">
    <button disabled={page ===1} className='p-2 bg-blue-500 text-white rounded-lg font-semibold' onClick={()=>{setPage(prev=>prev - 1)}}>Prev</button>
    <button className='p-2 bg-blue-500 text-white rounded-lg font-semibold' onClick={()=>{setPage(prev=>prev + 1)}}>Next</button>
</div>
</div> 
